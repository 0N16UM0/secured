import calculator_callback from "./src/calc.js";
...
app.get("/", (request, response) => {
  ...
  if (name) {
    if (name === "public/calc.html") {
      ...
      try {
        // Changing the filePath to current working directory using the "path" method
...
app.get("/calc", calculator_callback);
